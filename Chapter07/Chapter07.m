...
% define an auxiliary 0/1-matrix whose entries = 0 w.proba=p
p = 1/4;
aux2 = (rand(m/2,m/2)<p);
...
disp(strcat('Percentage of errors:', 32, num2str(100*min(n1,n2)/100), 37))
...
plot(m_min:m_inc:m_max,100*nb_errors(:,1),'-*',...
    ...
    xlabel('size m of the randon graph');
